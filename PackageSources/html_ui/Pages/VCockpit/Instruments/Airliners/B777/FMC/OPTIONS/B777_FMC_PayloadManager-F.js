class B777_FMC_PayloadManager {
    ...
    showPage() {
		...
		let rows = [
            ...
            ["", ""],
            [(B777_FMC_PayloadManager.remainingPayload ? 'REMAINING PAYLOAD' : ''), (B777_FMC_PayloadManager.remainingPayload ? B777_FMC_PayloadManager.remainingPayload + ' lb' : '')],
            ["\xa0RETURN TO", ""],
            ["<INDEX", "EXECUTE>"]
        ];
    ...
    async calculatePayload(requestedPayload) {
		...
		let amount = 0;
		let requestedCenterOfGravity = (B777_FMC_PayloadManager.requestedCenterOfGravity ? B777_FMC_PayloadManager.requestedCenterOfGravity : this.getCenterOfGravity());
