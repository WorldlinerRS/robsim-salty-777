...
(function (B747_8_UpperEICAS) {
    class Display extends Airliners.EICASTemplateElement {
        ...
        init(_eicas) {
            ...
            if (gaugeTemplate != null) {
                this.allEngineInfos.push(new B777F_EICAS_Gauge_N1(1, this.querySelector("#N1_1_GAUGE"), gaugeTemplate, true));
                this.allEngineInfos.push(new B777F_EICAS_Gauge_N1(2, this.querySelector("#N1_2_GAUGE"), gaugeTemplate, true));
                
                gaugeTemplate.remove();
            }        
            gaugeTemplate = this.querySelector("#GaugeTemplate2");
            if (gaugeTemplate != null) {
                this.allEngineInfos.push(new B777F_EICAS_Gauge_EGT(1, this.querySelector("#EGT_1_GAUGE"), gaugeTemplate, true));
                this.allEngineInfos.push(new B777F_EICAS_Gauge_EGT(2, this.querySelector("#EGT_2_GAUGE"), gaugeTemplate, true));
    ...
    class B777F_EICAS_Gauge {
    }
    
    class B777F_EICAS_CircleGauge extends B777F_EICAS_Gauge {
        constructor(_engineIndex, _root, _template, _hideIfN1IsZero) {
            ...
            if ((this.root != null) && (_template != null)) {
                ...
                if (this.redMarker != null) {
                    this.redMarker.setAttribute("transform", this.defaultMarkerTransform + " rotate(" + B777F_EICAS_CircleGauge.MAX_ANGLE + ")");
                }
            }
            this.refresh(0, true);
        }
        ...
        refresh(_value, _force = false) {
            if ((_value != this.currentValue) || _force) {
                ...
                var angle = Math.max((this.valueToPercentage(this.currentValue) * 0.01) * B777F_EICAS_CircleGauge.MAX_ANGLE, 0.001);
                var angleo = Math.max((this.getN1LimitValue() * 0.01) * B777F_EICAS_CircleGauge.MAX_ANGLE, 0.001);
                var anglet = Math.max((this. getN1CommandedValue() * 0.01) * B777F_EICAS_CircleGauge.MAX_ANGLE, 0.001);
                ...
                if (this.orangeMarker != null) {
                    this.orangeMarker.setAttribute("transform", this.defaultMarkerTransform + " rotate(" + B777F_EICAS_CircleGauge.WARNING_ANGLE + ")");
                }
                if (this.throttleMarker != null) {
                    this.throttleMarker.setAttribute("transform", this.defaultMarkerTransform + " rotate(" + anglet + ")");
                }
                if (this.fill != null) {
                    var rad = angle * B777F_EICAS_CircleGauge.DEG_TO_RAD;
                ...
                if (this.predArc != null) {
                    var rad = angle * B777F_EICAS_CircleGauge.DEG_TO_RAD;
                    var radt = anglet * B777F_EICAS_CircleGauge.DEG_TO_RAD;
    ...
    B777F_EICAS_CircleGauge.MAX_ANGLE = 210;
    B777F_EICAS_CircleGauge.WARNING_ANGLE = 202;
    B777F_EICAS_CircleGauge.DEG_TO_RAD = (Math.PI / 180);
    class B787_10_EICAS_Gauge_TPR extends B777F_EICAS_CircleGauge {
        getCurrentValue() {
    ...
    class B777F_EICAS_Gauge_N1 extends B777F_EICAS_CircleGauge {
        getCurrentValue() {
    ...
    class B777F_EICAS_Gauge_EGT extends B777F_EICAS_CircleGauge {
        getCurrentValue() {
    ...
    class B787_10_EICAS_Gauge_N2 extends B777F_EICAS_CircleGauge {
        getCurrentValue() {
